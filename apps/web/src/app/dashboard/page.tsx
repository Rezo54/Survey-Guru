            ...
            <div className={styles.shell}>
                ...
                <section className={styles.main}>
                    ...
                    <div className={styles.content}>
                        ...
                        <section className={styles.heroGrid}><article className={styles.panel}><div className={styles.panelHead}><div><p className={styles.eyebrow}>Live market picture</p><h2>Soweto Retail Universe</h2></div><span className={styles.status}>● 72% searched</span></div><ProjectSummaryCheckpoint /><div className={styles.map}><DashboardCoverageMap /><Link className={styles.mapCta} href="/projects/demo/map">Explore authoritative coverage →</Link></div></article>
