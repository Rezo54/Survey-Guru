...
export default function StoreCaptureForm() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const invalidNumberQuestion = formConfig.form.questions.find((question) => question.type === 'number' && String(form.get(question.id) ?? '').trim() && customAnswers[question.id] === null);
