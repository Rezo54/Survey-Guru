...
export default function FieldMapPage() {
  ...
  return <main className={s.page}><div className={s.shell}>
    ...
    <section className={s.main}><div className={s.workspace}>
      ...
      <section className={s.action} aria-label="Demo evidence handoff"><p className={s.eyebrow}>Demo checkpoint · Search evidence captured</p><h2>Send the searched segment for reconciliation</h2><p>The example now moves from field capture into QA. The field worker does not mark coverage verified; authorised validation determines whether the evidence is sufficient.</p><div className={s.actionRow}><Link className={s.primary} href="/qa">Submit example to QA →</Link><span className={s.secondary}>4.8 km searched · 3 records queued</span></div></section>
