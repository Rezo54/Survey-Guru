...
export default function FieldMapPage() {
  ...
  return <main className={s.page}><div className={s.shell}>
    ...
    <section className={s.main}><div className={s.workspace}>
      ...
      <section className={s.action}><p className={s.eyebrow}>Next best action · Coverage evidence</p><h2>Search the assigned geography</h2><p>The shared map paints only server-reconciled project streets. Green is completed, amber is partial or uncertain, and red remains outstanding. One capturer’s accepted coverage is visible to every authorised user on the project.</p><div className={s.actionRow}><button className={s.primary}>Resume search</button><Link className={s.secondary} href="/projects/demo/map">View project coverage</Link><Link className={s.secondary} href="/field">Back to Today</Link></div></section>
