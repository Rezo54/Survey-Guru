...
function configure(){process.env.M365_TENANT_ID='11111111-1111-4111-8111-111111111111';process.env.M365_CLIENT_ID='test-client';process.env.M365_CLIENT_SECRET='secret-test-only';}
function clear(){delete process.env.M365_TENANT_ID;delete process.env.M365_CLIENT_ID;delete process.env.M365_CLIENT_SECRET;}
